 ...
 * 												2- EIGHT_BIT
 * 	*/
#define CLCD_u8BIT_MODE 		FOUR_MODE
...
#define CLCD_u8D4_PIN			DIO_u8PIN1
#define CLCD_u8D5_PIN			DIO_u8PIN2
#define CLCD_u8D6_PIN			DIO_u8PIN3
#define CLCD_u8D7_PIN			DIO_u8PIN4
